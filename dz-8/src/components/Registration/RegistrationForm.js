        ...
        <div class="registration-box center">
            ...
            <form class="registration-form">
                ...
                <div class="registration-form__radio">
                    ...
                    <label class="registration-form__radio_hover" for="radio1">Male</label>

                    <input type="radio" id="radio2" name="radio"></input>
                    <label class="registration-form__radio_hover" for="radio2">Female</label>
                </div>
            ...
            <div class="loyalty-benefit">
                <h1 class="loyalty-benefit__title">LOYALTY HAS ITS PERKS</h1>
                ...
                <ul class="loyalty-benefit__points">
                    <li class="loyalty-benefit__point">15% off welcome offer</li>
                    <li class="loyalty-benefit__point">Free shipping, returns and exchanges on&nbsp;all orders</li>
                    <li class="loyalty-benefit__point">$10 off a&nbsp;purchase on&nbsp;your birthday</li>
                    <li class="loyalty-benefit__point">Early access to&nbsp;products</li>
                    <li class="loyalty-benefit__point">Exclusive offers &amp;&nbsp;rewards</li>
                </ul>
