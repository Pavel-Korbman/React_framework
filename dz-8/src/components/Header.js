    ...
    return (
        ...
        <header className="header center">
            <div className="header__logo">
                <a href="/"><img src={require('../img/sign.png')} alt="logo"></img></a>

                <a href="/"><svg width="26" height="27" viewBox="0 0 26 27" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <nav className="header__buttons">
                <div className="burger__button">
                    <a href="/catalog"><svg width="32" height="23" viewBox="0 0 32 23" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" fill="#E8E8E8" />
                    </svg>
                    </a>
                    <nav className="burger__menu">
                        <h2 className="burger__title">MENU</h2>
                        <div>
                            <h2 className="burger__subtitle">MAN</h2>
                            <ul className="burger__list">
                                <li key='Accessories'><a className="burger__text" href="/catalog">Accessories</a></li>
                                <li key='Bags'><a className="burger__text" href="/catalog">Bags</a></li>
                                <li key='Denim'><a className="burger__text" href="/catalog">Denim</a></li>
                                <li key='T-Shirts'><a className="burger__text" href="/catalog">T-Shirts</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="burger__subtitle">WOMAN</h2>
                            <ul className="burger__list">
                                <li key='Accessories'><a className="burger__text" href="/catalog">Accessories</a></li>
                                <li key='Bags'><a className="burger__text" href="/catalog">Jackets &amp;&nbsp;Coats</a></li>
                                <li key='Denim'><a className="burger__text" href="/catalog">Polos</a></li>
                                <li key='T-Shirts'><a className="burger__text" href="/catalog">T-Shirts</a></li>
                                <li key='Shirts'><a className="burger__text" href="/catalog">Shirts</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="burger__subtitle">KIDS</h2>
                            <ul className="burger__list">
                                <li key='Accessories'><a className="burger__text" href="/catalog">Accessories</a></li>
                                <li key='Jackets'><a className="burger__text" href="/catalog">Jackets &amp;&nbsp;Coats</a></li>
                                <li key='Polos'><a className="burger__text" href="/catalog">Polos</a></li>
                                <li key='T-Shirts'><a className="burger__text" href="/catalog">T-Shirts</a></li>
                                <li key='Shirts'><a className="burger__text" href="/catalog">Shirts</a></li>
                                <li key='Bags'><a className="burger__text" href="/catalog">Bags</a></li>
                            </ul>
                ...
                <a className="mobyle__off" href="/registration"><svg width="29" height="29" viewBox="0 0 29 29" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path className="header__icon"
                ...
                <a className="mobyle__off" href="/card"><svg width="32" height="29" viewBox="0 0 32 29" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path className="header__icon"
