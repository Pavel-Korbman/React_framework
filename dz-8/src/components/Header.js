    ...
    return (
        ...
        <header class="header center">
            <div class="header__logo">
                <a href="/"><img src="/sign.png" alt="logo"></img></a>
            ...
            <nav class="header__buttons">
                ...
                <a class="mobyle__off" href="#"><svg width="29" height="29" viewBox="0 0 29 29" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="mobyle__off" href="#"><svg width="32" height="29" viewBox="0 0 32 29" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path class="header__icon"
