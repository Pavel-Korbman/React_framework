            ...
            <nav class="header__buttons">
                <div class="burger__button">
                    ...
                    <nav class="burger__menu">
                        <h2 class="burger__title">MENU</h2>
                        <div>
                            <h2 class="burger__subtitle">MAN</h2>
                            <ul class="burger__list">
                                <li><a class="burger__text" href="/catalog">Accessories</a></li>
                                <li><a class="burger__text" href="/catalog">Bags</a></li>
                                <li><a class="burger__text" href="/catalog">Denim</a></li>
                                <li><a class="burger__text" href="/catalog">T-Shirts</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="burger__subtitle">WOMAN</h2>
                            <ul class="burger__list">
                                <li><a class="burger__text" href="/catalog">Accessories</a></li>
                                <li><a class="burger__text" href="/catalog">Jackets &amp;&nbsp;Coats</a></li>
                                <li><a class="burger__text" href="/catalog">Polos</a></li>
                                <li><a class="burger__text" href="/catalog">T-Shirts</a></li>
                                <li><a class="burger__text" href="/catalog">Shirts</a></li>
                            </ul>
                        </div>
                        <div>
                            <h2 class="burger__subtitle">KIDS</h2>
                            <ul class="burger__list">
                                <li><a class="burger__text" href="/catalog">Accessories</a></li>
                                <li><a class="burger__text" href="/catalog">Jackets &amp;&nbsp;Coats</a></li>
                                <li><a class="burger__text" href="/catalog">Polos</a></li>
                ...
                <a class="mobyle__off" href="/registration"><svg width="29" height="29" viewBox="0 0 29 29" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="mobyle__off" href="/card"><svg width="32" height="29" viewBox="0 0 32 29" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path class="header__icon"
