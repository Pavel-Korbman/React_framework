        ...
        <div className="card-box center">
            <div className="product-box-card">
                ...
                <div className="product-card">
                    <img className="product-card__image" src= {require("../../img/product_1.jpg")} alt="product"></img>

                    <div className="product-card__content">
                        <a href="/product">
                            <div className="product-card__name">MANGO PEOPLE T-SHIRT</div>
                        </a>
                        <div className="product-card__prise">Prise:
                            <div className="product-card__prise__item">$300</div>
                        </div>
                        ...
                        <div className="product-card__quantity">Quantity:
                            <input className="product-card__quantity__item" type="number"></input>
                        </div>
            ...
            <div className="order-box">
                ...
                <div className="proceed">
                    <div className="proseed__text">
                        <div className="subtotal">SUB TOTAL <span className="subtotal__item">$900</span>
                        </div>
                        <div className="grandtotal">GRAND TOTAL <span className="grandtotal__item">$900</span>
                        </div>
                    </div>
