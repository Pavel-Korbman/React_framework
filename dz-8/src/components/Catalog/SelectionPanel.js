            ...
            <div className="selection-panel__selector">
                ...
                <details className="selection-panel__selector__item">
                    ...
                    <div className="selection-panel__selector__item__menu">
                        <ul>
                            <li><input className="selection-panel__selector__item__menu__punkt" type="checkbox" value={'XS'}></input>XS</li>
                            <li><input className="selection-panel__selector__item__menu__punkt" type="checkbox" value={'S'}></input>S</li>
                            <li><input className="selection-panel__selector__item__menu__punkt" type="checkbox" value={'M'}></input>M</li>
                            <li><input className="selection-panel__selector__item__menu__punkt" type="checkbox" value={'L'}></input>L</li>
                        </ul>
                    </div>
                </details>
